...
# fragments[0].backward()

# i = 2
# loss = fragments[i].sum()
# loss.backward()
# fragments[1].backward()
# fragments[1].backward()
# fragments[3].backward()

# fragments[0].backward

# _shader = SoftSilhouetteShader()
# _shader(rasterize_meshes(mesh, image_size = img_size, blur_radius=0, faces_per_pixel=8, perspective_correct= False, ), mesh)
# _shader(fragments, mesh)
